...
namespace Ent {
	...
	EntityManager::~EntityManager() {
		this->removeAllEntities();				//tira todas as entidades ativas e põem em removeAndAvailable, chama removeComponentsOfEntity e, todos os sistemas fazem update e removem cada entidade
